...
import { API_METHODS, emailRegex, ENDPOINTS, Navigations } from '../../../constant';
        ...
        <ScrollView bounces={false} showsVerticalScrollIndicator={false}>
          <View
            ...
            <View
              ...
              <Text style={styles.contentHeaderText}>Login to your account</Text>
              <CommonTextInput
                title={'Email Address'}
              ...
              <ButtonView
                ...
                onPress={() => {
                  //   navigation.navigate(AppScreens.ForgotPassword);
                }}
              />
              ...
              <TouchableOpacity
                ...
                <Text style={styles.skipText}>Don't have an account? Signup</Text>
              </TouchableOpacity>
            </View>
          </View>
